##
# \file test_analyzer_vacf.py
# \author Michael P. Howard
# \date 8 January 2015
# \brief Implementation of Python unit tests for analyzer.vacf

import unittest
from mdalyzer import *

##
# \brief Test suite for velocity autocorrelation calculator
class analyzer_msd_tests(unittest.TestCase):
    ...
    def test_default_init(self):
        t = trajectory.hoomd()
        a = analyzer.vacf(traj=t)
        
        self.assertEqual(a.file_name, 'vacf')
    ...
    def test_full_init(self):
        t = trajectory.hoomd()
        a = analyzer.vacf(traj=t, file_name='foo', origins=5, name='bar', types=['A','C'])
    ...
    def test_delete_type(self):
        t = trajectory.hoomd()
        a = analyzer.vacf(traj=t, types=['A','B','C','D'])
